...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('aldryn_news_category', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal('aldryn_news', ['Category'])

        # Adding model 'CategoryTranslation'
        db.create_table('aldryn_news_category_translation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=255, blank=True)),
            ('language_code', self.gf('django.db.models.fields.CharField')(max_length=15, db_index=True)),
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', null=True, to=orm['aldryn_news.Category'])),
        ))
        db.send_create_signal('aldryn_news', ['CategoryTranslation'])

        # Adding unique constraint on 'CategoryTranslation', fields ['slug', 'language_code']
        db.create_unique('aldryn_news_category_translation', ['slug', 'language_code'])

        # Adding unique constraint on 'CategoryTranslation', fields ['language_code', 'master']
        db.create_unique('aldryn_news_category_translation', ['language_code', 'master_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'CategoryTranslation', fields ['language_code', 'master']
        db.delete_unique('aldryn_news_category_translation', ['language_code', 'master_id'])

        # Removing unique constraint on 'CategoryTranslation', fields ['slug', 'language_code']
        db.delete_unique('aldryn_news_category_translation', ['slug', 'language_code'])

        # Deleting model 'Category'
        db.delete_table('aldryn_news_category')

        # Deleting model 'CategoryTranslation'
        db.delete_table('aldryn_news_category_translation')
