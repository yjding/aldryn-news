...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('aldryn_news_news_translation', (
            ...
            ('master', self.gf('django.db.models.fields.related.ForeignKey')(related_name='translations', null=True, to=orm['aldryn_news.News'])),
        ))
        db.send_create_signal('aldryn_news', ['NewsTranslation'])

        # Adding unique constraint on 'NewsTranslation', fields ['language_code', 'master']
        db.create_unique('aldryn_news_news_translation', ['language_code', 'master_id'])

        # Adding model 'News'
        db.create_table('aldryn_news_news', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('aldryn_news', ['News'])
        ...
        db.send_create_signal('aldryn_news', ['LatestNewsPlugin'])

        # Adding M2M table for field tags on 'LatestNewsPlugin'
        db.create_table('aldryn_news_latestnewsplugin_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('latestnewsplugin', models.ForeignKey(orm['aldryn_news.latestnewsplugin'], null=False)),
            ('tag', models.ForeignKey(orm['taggit.tag'], null=False))
        ))
        db.create_unique('aldryn_news_latestnewsplugin_tags', ['latestnewsplugin_id', 'tag_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'NewsTranslation', fields ['language_code', 'master']
        db.delete_unique('aldryn_news_news_translation', ['language_code', 'master_id'])

        # Deleting model 'NewsTranslation'
        db.delete_table('aldryn_news_news_translation')

        # Deleting model 'News'
        db.delete_table('aldryn_news_news')

        # Deleting model 'LatestNewsPlugin'
        db.delete_table('cmsplugin_latestnewsplugin')

        # Removing M2M table for field tags on 'LatestNewsPlugin'
        db.delete_table('aldryn_news_latestnewsplugin_tags')
    ...
    models = {
        ...
        'aldryn_news.newstranslation': {
            'Meta': {'unique_together': "[('language_code', 'master')]", 'object_name': 'NewsTranslation', 'db_table': "'aldryn_news_news_translation'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
