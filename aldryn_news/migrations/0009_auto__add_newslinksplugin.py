...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NewsLinksPlugin'
        db.create_table('cmsplugin_newslinksplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('aldryn_news', ['NewsLinksPlugin'])

        # Adding M2M table for field news on 'NewsLinksPlugin'
        db.create_table('aldryn_news_newslinksplugin_news', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('newslinksplugin', models.ForeignKey(orm['aldryn_news.newslinksplugin'], null=False)),
            ('news', models.ForeignKey(orm['aldryn_news.news'], null=False))
        ))
        db.create_unique('aldryn_news_newslinksplugin_news', ['newslinksplugin_id', 'news_id'])


    def backwards(self, orm):
        # Deleting model 'NewsLinksPlugin'
        db.delete_table('cmsplugin_newslinksplugin')

        # Removing M2M table for field news on 'NewsLinksPlugin'
        db.delete_table('aldryn_news_newslinksplugin_news')
    ...
    models = {
        ...
        'aldryn_news.newslinksplugin': {
            'Meta': {'object_name': 'NewsLinksPlugin', 'db_table': "'cmsplugin_newslinksplugin'", '_ormbases': ['cms.CMSPlugin']},
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'news': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['aldryn_news.News']", 'symmetrical': 'False'})
        },
        ...
        'aldryn_news.tagtranslation': {
            'Meta': {'unique_together': "[['slug', 'language_code'], ('language_code', 'master')]", 'object_name': 'TagTranslation', 'db_table': "'aldryn_news_tag_translation'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'language_code': ('django.db.models.fields.CharField', [], {'max_length': '15', 'db_index': 'True'}),
