...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TagsPlugin'
        db.create_table('cmsplugin_tagsplugin', (
            ('cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('aldryn_news', ['TagsPlugin'])

        # Adding M2M table for field tags on 'TagsPlugin'
        db.create_table('aldryn_news_tagsplugin_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('tagsplugin', models.ForeignKey(orm['aldryn_news.tagsplugin'], null=False)),
            ('tag', models.ForeignKey(orm['taggit.tag'], null=False))
        ))
        db.create_unique('aldryn_news_tagsplugin_tags', ['tagsplugin_id', 'tag_id'])


    def backwards(self, orm):
        # Deleting model 'TagsPlugin'
        db.delete_table('cmsplugin_tagsplugin')

        # Removing M2M table for field tags on 'TagsPlugin'
        db.delete_table('aldryn_news_tagsplugin_tags')
    ...
    models = {
        ...
        'aldryn_news.tagsplugin': {
            'Meta': {'object_name': 'TagsPlugin', 'db_table': "'cmsplugin_tagsplugin'", '_ormbases': ['cms.CMSPlugin']},
            'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['taggit.Tag']", 'symmetrical': 'False', 'blank': 'True'})
        },
        'auth.group': {
