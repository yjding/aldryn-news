...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LatestNewsPlugin.type_list'
        db.add_column('cmsplugin_latestnewsplugin', 'type_list',
                      self.gf('django.db.models.fields.CharField')(default='full', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LatestNewsPlugin.type_list'
        db.delete_column('cmsplugin_latestnewsplugin', 'type_list')
