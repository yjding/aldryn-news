...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'TagTranslation', fields ['slug']
        db.delete_unique('aldryn_news_tag_translation', ['slug'])

        # Adding unique constraint on 'TagTranslation', fields ['slug', 'language_code']
        db.create_unique('aldryn_news_tag_translation', ['slug', 'language_code'])


    def backwards(self, orm):
        # Removing unique constraint on 'TagTranslation', fields ['slug', 'language_code']
        db.delete_unique('aldryn_news_tag_translation', ['slug', 'language_code'])

        # Adding unique constraint on 'TagTranslation', fields ['slug']
        db.create_unique('aldryn_news_tag_translation', ['slug'])
