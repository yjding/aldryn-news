...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('aldryn_news_news', 'category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['aldryn_news.Category'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'News.category'
        db.delete_column('aldryn_news_news', 'category_id')
